...
train_set_path = 'G:\Python\KMold\screenshots\digits'
test_set_path = 'G:\Python\KMold\screenshots\digits'
...
classifier.save('digit_recognition_model_simplified')
...
print('Average epoch computation time for model is: {:.2f}'.format(mean(timesLD)))
...
screenshot = screenshot.reshape((1, screenshot.shape[0], screenshot.shape[1], 1))
